      ...
      >
        <Container maxWidth="lg" sx={{position: 'relative', zIndex: 1}}>
          <Box sx={{display: 'flex', flexDirection: {xs: 'column', md: 'row'}, gap: 4, alignItems: 'center'}}>
            {/* Main Content */}
            <Box sx={{flex: {xs: '1', md: '7'}, color: 'text.primary', mb: 4}}>
              {/* Title */}
              <Typography
                sx={{
              ...
              >
                ...
                <Box sx={{display: 'flex', flexDirection: 'column', gap: 3}}>
                  ...
                  <Box sx={{display: 'flex', alignItems: 'center', gap: 2}}>
                    ...
                    >
                      <Map color="#1976d2" size={20} />
                    </Box>
                    <Box>
                      <Typography sx={{fontWeight: 600, mb: 0.5, color: 'text.primary'}} variant="h6">
                  ...
                  <Box sx={{display: 'flex', alignItems: 'center', gap: 2}}>
                    ...
                    <Box>
                      ...
                      <Typography sx={{color: 'text.secondary'}} variant="body2">
                        Witness U2's transformation from local band to global phenomenon
                      </Typography>
                    </Box>
                  </Box>
                </Box>
                ...
                <Box sx={{display: 'flex', justifyContent: 'space-around', textAlign: 'center'}}>
                  <Box>
                    <Typography sx={{fontWeight: 700, mb: 0.5, color: '#1976d2'}} variant="h4">
                      20+
                    </Typography>
                  ...
                  <Box>
                    <Typography sx={{fontWeight: 700, mb: 0.5, color: '#9c27b0'}} variant="h4">
                      500+
                    </Typography>
                    <Typography sx={{color: 'text.secondary'}} variant="caption">
                      Concerts
                  ...
                  <Box>
                    <Typography sx={{fontWeight: 700, mb: 0.5, color: '#4caf50'}} variant="h4">
                      35+
                    </Typography>
                    <Typography sx={{color: 'text.secondary'}} variant="caption">
                      Countries
